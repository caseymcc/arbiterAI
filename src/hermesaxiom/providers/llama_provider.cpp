...
LlamaProvider& LlamaProvider::instance()
{
...
ErrorCode LlamaProvider::completion(const std::string& prompt, std::string& result)
{
    // tokenize the prompt
...
ErrorCode LlamaProvider::streamingCompletion(const std::string& prompt,
...
ErrorCode LlamaProvider::getEmbeddings(const std::string& input,
...
bool LlamaProvider::isModelDownloaded(const LlamaModelInfo& modelInfo) const
{
...
void LlamaProvider::downloadModel(LlamaModelInfo& modelInfo)
{
...
DownloadStatus LlamaProvider::getDownloadStatus(const std::string& modelName, std::string& error)
{
...
bool LlamaProvider::isLoaded(const std::string& modelName) const
{
...
bool LlamaProvider::loadModel(const std::string& modelName)
{
    if (m_modelInfo && m_modelInfo->model == modelName) {
        return true;
    }
...
void LlamaProvider::loadLlamaConfig()
{
